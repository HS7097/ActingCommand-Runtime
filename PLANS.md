...
Current implementation: C1 Tasks 1-3 are complete and approved: typed event/query/projection contracts, pre-persistence redaction, recoverable single-writer append storage, correlated ordered queries, recovered indexes, race-free replay-plus-live subscriptions with bounded nonblocking delivery, and separate CLI/UI/Lab projections. Task 4 critical intent/action/outcome ordering is not implemented yet.

...
Current phase: C1 global event contract and ledger skeleton hardening. Tasks 1-5 of the original C1 plan are complete. The whole-branch review found 2 Critical, 8 Important, and 3 Minor findings, and Alice approved strengthening C1 rather than narrowing its guarantees. Hardening Tasks 1-5 are complete. Event and persisted-fact authority, post-action critical outcomes, and bounded absorbing subscriptions are hardened. Startup now opens and owns the store synchronously while a writer waits without filesystem authority; every failed startup joins that writer and releases ownership before returning. Writer timestamps are nonzero diagnostic observations rather than an ordering clock, non-final empty segments fail closed, and config diagnostics redact root and owner identity. Hardening Task 6, crash-atomic tail repair journal, is next. Alice approved the complete Issue #35 chain and clarified that C0-C7 nodes do not require separate approval. The approved C0 architecture is `docs/architecture/runtime-ledger-v3-c0-freeze.md`, payload SHA-256 `6c72a9c39ff67ec5a2868e0ed262d2a2f0a2c4b0fbfc473b7c55a9df610bf0a7`.

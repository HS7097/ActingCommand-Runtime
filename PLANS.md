...
Current phase: C1 global event contract and ledger skeleton hardening. Tasks 1-5 of the original C1 plan are complete. The whole-branch review found 2 Critical, 8 Important, and 3 Minor findings, and Alice approved strengthening C1 rather than narrowing its guarantees. Hardening Tasks 1-4 are complete. The event v2 and opaque-ledger-fact migration closes producer and persisted-fact authority, the critical executor records only the real post-action outcome, and subscriptions now register at a fixed high-water mark, pull replay in pages of at most 1024 events, preserve gap-free replay-to-live ordering, expose resumable cursors, and latch fatal or clean terminal states while discarding buffers. Hardening Task 5, owned startup and storage invariants, is next. Alice approved the complete Issue #35 chain and clarified that C0-C7 nodes do not require separate approval. The approved C0 architecture is `docs/architecture/runtime-ledger-v3-c0-freeze.md`, payload SHA-256 `6c72a9c39ff67ec5a2868e0ed262d2a2f0a2c4b0fbfc473b7c55a9df610bf0a7`.

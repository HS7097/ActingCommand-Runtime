...
Current phase: C1 global event contract and ledger skeleton hardening. Tasks 1-5 of the original C1 plan are complete. The whole-branch review found 2 Critical, 8 Important, and 3 Minor findings, and Alice approved strengthening C1 rather than narrowing its guarantees. Hardening Tasks 1-2 are now complete as one atomic schema-owned event v2 and opaque-ledger-fact migration. Producer codes and IDs are closed or issuer-owned, artifact ingress is store-capability-only, persisted facts are ledger-owned, and recovery rejects artifact-bearing records until the C2 durable store verifier exists. Hardening Task 3, post-action critical outcomes, is next. Alice approved the complete Issue #35 chain and clarified that C0-C7 nodes do not require separate approval. The approved C0 architecture is `docs/architecture/runtime-ledger-v3-c0-freeze.md`, payload SHA-256 `6c72a9c39ff67ec5a2868e0ed262d2a2f0a2c4b0fbfc473b7c55a9df610bf0a7`.

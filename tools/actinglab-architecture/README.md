...
The v1 registry lives in `generic-domain-v1.toml`; its content-addressed item manifest lives in
`generic-domain-surfaces-v1.jsonl`. Rust public and wire items, `closed_code!` variants and wire
...
Generated provenance records a fixed generator path, generator byte hash, full Git revision, stable

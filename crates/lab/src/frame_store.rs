...
use crate::{LabError as CliError, LabResult as CliOutcome};
...
impl FrameStoreConfig {
    ...
    pub(crate) fn with_memory_source(mut self, source: MemorySampleSource) -> Self {
...
/// Keeps platform sampling in the app while preserving per-frame budget refreshes in Lab.
#[derive(Debug, Clone, Copy)]
